...
class CallbackModule(CallbackBase):
    ...
    def __init__(self):
        ...
        self._options: context.CLIArgs = context.CLIARGS
    ...
    def raw_vars(self, play, host, hostvars):
        ...
        keys = set(
            pattern.split("\.")[  # pyright: ignore [reportInvalidStringEscapeSequence]
                0
            ]
    ...
    def darwin_without_passlib(self):
        ...
        try:
            import passlib.hash  # pyright: ignore [reportUnusedImport]

            return False
        except:
            return True

    def v2_playbook_on_play_start(  # pyright: ignore [reportImplicitOverride]
        self, play
    ):
        play_context = PlayContext(play=play)  # pyright: ignore [reportUnusedVariable]
        ...
        if env_group:
            env_group.set_priority(20)  # pyright: ignore [reportAttributeAccessIssue]
